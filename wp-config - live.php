...
define('DB_NAME', 'kiokarma_properties');

/** MySQL database username */
define('DB_USER', 'kiokarma_mybali');

/** MySQL database password */
define('DB_PASSWORD', 'HdRXN!;urt3]');
...
define('WP_HOME','http://www.mybaliproperties.com/');
define('WP_SITEURL','http://www.mybaliproperties.com/');
